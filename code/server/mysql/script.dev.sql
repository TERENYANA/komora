...
VALUES
    ...
    (NULL, 'Blini', 'Thin pancakes served with sour cream, jam, or caviar.', 4.99, 'LipovuiMed.png', 0.200, 80, 2, 1),
    ...
    (NULL, 'Smetana', 'A thick, tangy sour cream used in soups, sauces, and desserts.', 4.49, 'LipovuiMed.png', 0.400, 60, 4, 2),  
    (NULL, 'Tvorog', 'A fresh, crumbly farmer’s cheese commonly used in Slavic cuisine.', 5.99, 'LipovuiMed.png', 0.500, 40, 4, 2),
    (NULL, 'Adjika', 'A spicy Georgian sauce made from red peppers, garlic, and herbs, perfect for meat and vegetables.', 4.99, 'LipovuiMed.png', 0.250, 60, 5, 3),  
    (NULL, 'Tkemali', 'A sour plum sauce from Georgia, used as a condiment for grilled meats and potatoes.', 5.49, 'LipovuiMed.png', 0.300, 50, 5, 3),  
    (NULL, 'Horseradish Sauce (Hren)', 'A strong and spicy condiment made from grated horseradish, popular in Slavic cuisine.', 3.99, 'LipovuiMed.png', 0.200, 70, 5, 3), 
    (NULL, 'Grechka (Buckwheat)', 'A nutritious, gluten-free cereal made from buckwheat, often enjoyed as a porridge or side dish.', 3.49, 'LipovuiMed.png', 0.400, 80, 6, 4),  
    (NULL, 'Kasha', 'A traditional Eastern European dish made from buckwheat, usually served as a savory side or breakfast porridge.', 3.99, 'LipovuiMed.png', 0.500, 100, 6, 4),  
    (NULL, 'Barley Groats', 'A wholesome cereal made from barley, perfect for hearty soups, stews, or as a nutritious side dish.', 2.99, 'LipovuiMed.png', 0.400, 90, 6, 4),
    (NULL, 'Kvas', 'A traditional fermented Slavic beverage made from rye bread, slightly sweet with a tangy taste.', 2.49, 'LipovuiMed.png', 0.500, 120, 7, 5),  
    (NULL, 'Kompot', 'A sweet fruit drink made by boiling fresh fruit, often served chilled as a refreshing beverage.', 3.49, 'LipovuiMed.png', 1.000, 90, 7, 5),  
    (NULL, 'Tarhun', 'A popular Soviet-era green tarragon soda with a unique herbal flavor and sweetness.', 1.99, 'LipovuiMed.png', 0.500, 150, 7, 5),  
    (NULL, 'Sprite', 'A well-known lemon-lime soda, refreshing with a crisp and sweet flavor.', 1.29, 'LipovuiMed.png', 0.330, 200,7, 5),
    (NULL, 'Sunflower Seeds', 'Roasted sunflower seeds, a crunchy and salty snack, perfect for munching on the go.', 1.99, 'LipovuiMed.png', 0.150, 200, 8, 1),  
    (NULL, 'Potato Chips', 'Crispy, thinly sliced potatoes fried to perfection with a salty flavor.', 2.49, 'LipovuiMed.png', 0.200, 150, 8, 1),  
    (NULL, 'Puffed Corn', 'Light and crispy puffed corn snack, perfect for satisfying your snack cravings with a mild salty taste.', 2.79, 'LipovuiMed.png', 0.250, 120, 8, 1),  
    (NULL, 'Cheese Balls', 'Crunchy corn-based cheese-flavored snack, a popular treat for kids and adults alike.', 3.29, 'LipovuiMed.png', 0.200, 180, 8, 2);
